    ...
    <div style={{ fontFamily, color: colors.text, margin: 0, padding: 0, overflowX: 'hidden' }}>
      ...
      >
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          >
            24/7 Emergency Response &bull; Bloomfield Township
          </div>
          ...
          >
            #1 Water Damage Restoration Company in Bloomfield
          </h1>
          ...
          >
            ...
            Serving Bloomfield Hills, Bloomfield Township, and surrounding Oakland County communities.
          </p>

          {/* Address - links to Google Maps */}
          <a
            href="https://www.google.com/maps/place/4060+W+Maple+Rd,+Bloomfield+Township,+MI+48301"
            target="_blank"
          ...
          >
            {[
              ...
              },
              {
                ...
                title: 'Bloomfield Experts',
                description:
                  'We\'re not a national franchise dispatching crews from who-knows-where. We\'re local to Bloomfield and deeply familiar with the homes, building styles, and common water damage risks in this area. That local knowledge means faster diagnosis, better solutions, and a team that genuinely cares about your community.',
              },
              {
        ...
        >
          ...
          <div>
            ...
            >
              ...
              it does\u2014to your floors, your walls, your belongings, and your peace of mind. That&apos;s why
            ...
            >
              ...
              local Bloomfield crews are strategically positioned so we can reach your property quickly,
      ...
      <section id="contact" style={{ backgroundColor: colors.dark, padding: '80px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          >
            ...
            >
              <MapPinIcon size={48} color={colors.accent} />
              <p
                style={{
                  fontSize: 15,
                  fontWeight: 500,
