      ...
      <header className="sticky top-0 z-50 bg-white" style={{ boxShadow: 'rgba(0,0,0,0.02) 0px 0px 0px 1px, rgba(0,0,0,0.04) 0px 2px 6px' }}>
        <div className="max-w-[1120px] mx-auto flex items-center justify-between px-6 py-4">
          ...
          <nav className="hidden lg:flex items-center gap-8">
            <a href="/" className="text-[#222222] text-[15px] font-medium hover:text-[#ff385c] transition-colors duration-150">Home</a>
            <a href="/bloomfield" className="text-[#222222] text-[15px] font-medium hover:text-[#ff385c] transition-colors duration-150">Bloomfield</a>
            <a href="/services/smoke-odor-removal" className="text-[#222222] text-[15px] font-medium hover:text-[#ff385c] transition-colors duration-150">Smoke &amp; Odor</a>
            <a href="/services/soot-cleanup" className="text-[#222222] text-[15px] font-medium hover:text-[#ff385c] transition-colors duration-150">Soot Cleanup</a>
            <a href="#contact" className="text-[#222222] text-[15px] font-medium hover:text-[#ff385c] transition-colors duration-150">Contact</a>
          </nav>
          <a href={PHONE_HREF} className="hidden md:flex items-center gap-2 text-[#222222] hover:text-[#ff385c] transition-colors duration-150">
            <PhoneIcon />
        ...
        <section className="bg-white" style={{ paddingTop: '80px', paddingBottom: '72px' }}>
          <div className="max-w-[1120px] mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-14">
              ...
              <a href={SMS_HREF} className="inline-flex items-center justify-center gap-2 text-[#222222] font-semibold text-base no-underline transition-colors duration-150" style={{ borderRadius: '8px', padding: '0 28px', height: '52px', border: '2px solid #222222', backgroundColor: 'transparent' }}>
                <SmsIcon />
                Text Us
              </a>
            </div>
